...
-- The upload CSV has a single JSON_DATA column ($1); id and updatetimestamp
-- are generated by the table defaults (AUTOINCREMENT / CURRENT_TIMESTAMP),
-- so they're not listed in the COPY column list.
